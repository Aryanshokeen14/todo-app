...
function App() { 
  ...
  return (
    <>
    <Navbar/> 
       <div className="mx-3 md:container md:mx-auto my-16 rounded-xl p-5 bg-violet-100 min-h-[89vh] md:w-[40%]">
        <h1 className='font-bold text-center text-3xl'>iTask - Manage your todos at one place</h1>
         ...
         <div className="todos">
          ...
          return (showFinished || !item.isCompleted) && <div key={item.id} className={"todo flex my-3 justify-between "}>
            ...
            <div className={item.isCompleted?"line-through":" break-all"}>{item.todo}</div>
            </div>
